  ...
  return (
    ...
    `}>
      <div className={`
        ...
        bg-gradient-to-br from-parchment-50 via-vintage-cream to-parchment-100 dark:from-vintage-darkbrown dark:via-vintage-brown dark:to-parchment-800
        rounded-lg shadow-2xl border-2 border-vintage-brown/30 dark:border-vintage-gold/20
        overflow-hidden
      ...
      `}>
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 z-10 w-10 h-10 rounded-full bg-vintage-brown/20 dark:bg-vintage-gold/20 hover:bg-vintage-rust/30 dark:hover:bg-vintage-gold/30 flex items-center justify-center text-vintage-ink dark:text-vintage-cream transition-all duration-200"
        ...
        <div className="relative px-8 py-8 border-b border-vintage-brown/20 dark:border-vintage-gold/20">
          <div className="absolute inset-0 bg-gradient-to-r from-parchment-100/40 to-parchment-200/40 dark:from-vintage-brown/40 dark:to-parchment-700/40"></div>
          <div className="relative">
            <h2 className="text-3xl md:text-4xl font-script text-vintage-ink dark:text-vintage-cream mb-2 text-center">
              {letter.title}
            </h2>
            <div className="flex items-center justify-center gap-4">
              <span className="inline-block px-4 py-2 bg-parchment-200/70 dark:bg-vintage-brown/70 rounded text-sm font-serif text-vintage-brown dark:text-vintage-cream capitalize tracking-wide border border-vintage-brown/20 dark:border-vintage-gold/20">
                {letter.category}
              </span>
              <span className="text-vintage-brown dark:text-vintage-gold font-serif italic">
                {getSectionTitle()}
              </span>
            </div>
          </div>
        ...
        <div className="px-8 py-8 overflow-y-auto max-h-[60vh] relative">
          <div className="prose prose-lg max-w-none">
            <div className="text-vintage-ink dark:text-vintage-cream leading-relaxed font-serif text-lg whitespace-pre-line">
              {displayText}
              <span className="inline-block w-0.5 h-6 bg-vintage-brown dark:bg-vintage-gold ml-1 animate-pulse"></span>
            </div>
          </div>
        </div>
        ...
        <div className="px-8 py-6 border-t border-vintage-brown/20 dark:border-vintage-gold/20 bg-gradient-to-r from-parchment-100/60 to-parchment-200/60 dark:from-vintage-brown/60 dark:to-parchment-800/60">
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              {(['message', 'quote', 'reflection'] as const).map((section) => (
                <button
                  ...
                  className={`
                    px-4 py-2 rounded text-sm font-serif transition-all duration-200 border
            ...
            <div className="text-sm text-vintage-brown dark:text-vintage-gold font-serif">
